...
**Write so a smart senior colleague who does not know this domain understands it top-to-bottom on the first pass.**
...
- **Be direct and respectful**: Use a clear, explanatory tone. Always use Korean honorifics (존댓말).
- **Keep references out of the prose**: Don't weave file paths, line numbers, or source citations into headings or explanatory sentences. Instead, use footnotes or separate reference sections.
