...
5. **Risk-weighted** — the piece where a mistake would hurt most is named here, with the check that was run against it. Re-checked at the gate, not recalled from earlier — "verified deeply" with nothing to point at is not a pass. (Rule 10)
