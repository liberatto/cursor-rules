...
- **Korean**: Honorifics always. Write Korean prose that ends on a finite verb (never a bare noun or a trailing connective), carries relations in particles rather than noun stacks, swaps the em dash for a colon, and keeps figurative words out of plain slots. None of this adds length: a rewrite that got longer took the wrong turn.
