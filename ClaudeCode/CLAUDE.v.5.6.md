...
The test: Name the sentence the reader acts on, then the ones that only support it. Anything in neither group was never load-bearing — and if a first-time reader loses the thread once they're gone, you cut a supporting sentence by mistake.
